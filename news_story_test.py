...
class ProblemSet5(unittest.TestCase):
    ...
    def test1TitleTrigger(self):
        ...
        plural    = NewsStory('', 'Purple ows are cool!', '', '', datetime.now())
    ...
    def test7FilterStories(self):
        ...
        a = NewsStory('', "asfd New York City asfdasdfasdf", 'asfd New York City asfdasdfasdf', '', datetime.now())
        b = NewsStory('', "asdfasfd new york city! asfdasdfasdf", 'asdfasfd new york city! asfdasdfasdf', '', datetime.now())
        noa = NewsStory('', "something somethingnew york city", 'something somethingnew york city', '', datetime.now())
        nob = NewsStory('', "something something new york cities", 'something something new york cities', '', datetime.now())
